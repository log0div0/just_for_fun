...
BoxActor::BoxActor() {
	...
	wood_texture.reset(rhi::g_context->CreateTexture2D(g_assets_dir/"textures"/"Wood_Crate_001_basecolor.jpg"));
	lambda_texture.reset(rhi::g_context->CreateTexture2D(g_assets_dir/"textures"/"Half-Life_lambda_logo.png"));
